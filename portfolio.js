...
jQuery("#wowslider-container3").wowSlider({
    effect: "fade",
    prev: "",
    next: "",
    duration: 10 * 100,
...
jQuery("#wowslider-container5").wowSlider({
    effect: "fade",
    prev: "",
    next: "",
    duration: 10 * 100,
...
jQuery("#wowslider-container6").wowSlider({
    effect: "fade",
    prev: "",
    next: "",
    duration: 10 * 100,
...
jQuery("#wowslider-container7").wowSlider({
    effect: "fade",
    prev: "",
    next: "",
    duration: 10 * 100,
...
jQuery("#wowslider-container9").wowSlider({
    effect: "fade",
    prev: "",
    next: "",
    duration: 10 * 100,
...
jQuery("#wowslider-container10").wowSlider({
    effect: "fade",
    prev: "",
    next: "",
    duration: 10 * 100,
